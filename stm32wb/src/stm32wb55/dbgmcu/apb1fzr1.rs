...
///Field `DBG_WWDG_STOP` reader - WWDG counter stopped when core is halted
pub type DBG_WWDG_STOP_R = crate::BitReader<bool>;
///Field `DBG_WWDG_STOP` writer - WWDG counter stopped when core is halted
pub type DBG_WWDG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1FZR1_SPEC, bool, O>;
///Field `DBG_IWDG_STOP` reader - IWDG counter stopped when core is halted
pub type DBG_IWDG_STOP_R = crate::BitReader<bool>;
///Field `DBG_IWDG_STOP` writer - IWDG counter stopped when core is halted
pub type DBG_IWDG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1FZR1_SPEC, bool, O>;
///Field `DBG_I2C1_STOP` reader - Debug I2C1 SMBUS timeout stopped when Core is halted
pub type DBG_I2C1_STOP_R = crate::BitReader<bool>;
///Field `DBG_I2C1_STOP` writer - Debug I2C1 SMBUS timeout stopped when Core is halted
pub type DBG_I2C1_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1FZR1_SPEC, bool, O>;
///Field `DBG_I2C3_STOP` reader - Debug I2C3 SMBUS timeout stopped when core is halted
pub type DBG_I2C3_STOP_R = crate::BitReader<bool>;
///Field `DBG_I2C3_STOP` writer - Debug I2C3 SMBUS timeout stopped when core is halted
pub type DBG_I2C3_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1FZR1_SPEC, bool, O>;
///Field `DBG_LPTIM1_STOP` reader - Debug LPTIM1 stopped when Core is halted
pub type DBG_LPTIM1_STOP_R = crate::BitReader<bool>;
///Field `DBG_LPTIM1_STOP` writer - Debug LPTIM1 stopped when Core is halted
