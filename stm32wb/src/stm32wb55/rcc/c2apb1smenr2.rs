...
///Field `LPUART1SMEN` reader - Low power UART 1 clocks enable during CPU2 Sleep mode
pub type LPUART1SMEN_R = crate::BitReader<bool>;
///Field `LPUART1SMEN` writer - Low power UART 1 clocks enable during CPU2 Sleep mode
pub type LPUART1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB1SMENR2_SPEC, bool, O>;
///Field `LPTIM2SMEN` reader - Low power timer 2 clocks enable during CPU2 Sleep mode
pub type LPTIM2SMEN_R = crate::BitReader<bool>;
///Field `LPTIM2SMEN` writer - Low power timer 2 clocks enable during CPU2 Sleep mode
...
///`reset()` method sets C2APB1SMENR2 to value 0x21
