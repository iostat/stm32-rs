...
///Field `TIM1SMEN` reader - TIM1 timer clocks enable during CPU2 Sleep mode
pub type TIM1SMEN_R = crate::BitReader<bool>;
///Field `TIM1SMEN` writer - TIM1 timer clocks enable during CPU2 Sleep mode
pub type TIM1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB2SMENR_SPEC, bool, O>;
///Field `SPI1SMEN` reader - SPI1 clocks enable during CPU2 Sleep mode
pub type SPI1SMEN_R = crate::BitReader<bool>;
///Field `SPI1SMEN` writer - SPI1 clocks enable during CPU2 Sleep mode
pub type SPI1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB2SMENR_SPEC, bool, O>;
///Field `USART1SMEN` reader - USART1clocks enable during CPU2 Sleep mode
pub type USART1SMEN_R = crate::BitReader<bool>;
///Field `USART1SMEN` writer - USART1clocks enable during CPU2 Sleep mode
pub type USART1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB2SMENR_SPEC, bool, O>;
///Field `TIM16SMEN` reader - TIM16 timer clocks enable during CPU2 Sleep mode
pub type TIM16SMEN_R = crate::BitReader<bool>;
///Field `TIM16SMEN` writer - TIM16 timer clocks enable during CPU2 Sleep mode
pub type TIM16SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB2SMENR_SPEC, bool, O>;
///Field `TIM17SMEN` reader - TIM17 timer clocks enable during CPU2 Sleep mode
pub type TIM17SMEN_R = crate::BitReader<bool>;
///Field `TIM17SMEN` writer - TIM17 timer clocks enable during CPU2 Sleep mode
pub type TIM17SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB2SMENR_SPEC, bool, O>;
///Field `SAI1SMEN` reader - SAI1 clocks enable during CPU2 Sleep mode
pub type SAI1SMEN_R = crate::BitReader<bool>;
///Field `SAI1SMEN` writer - SAI1 clocks enable during CPU2 Sleep mode
...
///`reset()` method sets C2APB2SMENR to value 0x0026_5800
