...
///Field `IPCCDBA` reader - PCC mailbox data buffer base address
pub type IPCCDBA_R = crate::FieldReader<u16, u16>;
///Field `IPCCDBA` writer - PCC mailbox data buffer base address
...
///`reset()` method sets IPCCBR to value 0xffff_c000
