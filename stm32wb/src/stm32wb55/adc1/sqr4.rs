...
///Field `SQ15` reader - ADC group regular sequencer rank 15
pub type SQ15_R = crate::FieldReader<u8, u8>;
///Field `SQ15` writer - ADC group regular sequencer rank 15
pub type SQ15_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
///Field `SQ16` reader - ADC group regular sequencer rank 16
pub type SQ16_R = crate::FieldReader<u8, u8>;
///Field `SQ16` writer - ADC group regular sequencer rank 16
