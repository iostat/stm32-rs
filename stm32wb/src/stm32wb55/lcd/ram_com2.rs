...
///`read()` method returns [ram_com2::R](R) reader structure
impl crate::Readable for RAM_COM2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ram_com2::W](W) writer structure
impl crate::Writable for RAM_COM2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RAM_COM2 to value 0
