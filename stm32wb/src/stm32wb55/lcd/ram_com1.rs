...
///`read()` method returns [ram_com1::R](R) reader structure
impl crate::Readable for RAM_COM1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ram_com1::W](W) writer structure
impl crate::Writable for RAM_COM1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets RAM_COM1 to value 0
