...
///Field `DLYM1L` reader - Delay line for first microphone of pair 1
pub type DLYM1L_R = crate::FieldReader<u8, u8>;
///Field `DLYM1L` writer - Delay line for first microphone of pair 1
pub type DLYM1L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDMDLY_SPEC, u8, u8, 3, O>;
///Field `DLYM1R` reader - Delay line for second microphone of pair 1
pub type DLYM1R_R = crate::FieldReader<u8, u8>;
///Field `DLYM1R` writer - Delay line for second microphone of pair 1
...
///Field `DLYM3L` reader - Delay line for first microphone of pair 3
pub type DLYM3L_R = crate::FieldReader<u8, u8>;
///Field `DLYM3L` writer - Delay line for first microphone of pair 3
pub type DLYM3L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDMDLY_SPEC, u8, u8, 3, O>;
///Field `DLYM3R` reader - Delay line for second microphone of pair 3
pub type DLYM3R_R = crate::FieldReader<u8, u8>;
///Field `DLYM3R` writer - Delay line for second microphone of pair 3
pub type DLYM3R_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDMDLY_SPEC, u8, u8, 3, O>;
///Field `DLYM4L` reader - Delay line for first microphone of pair 4
pub type DLYM4L_R = crate::FieldReader<u8, u8>;
///Field `DLYM4L` writer - Delay line for first microphone of pair 4
pub type DLYM4L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDMDLY_SPEC, u8, u8, 3, O>;
///Field `DLYM4R` reader - Delay line for second microphone of pair 4
pub type DLYM4R_R = crate::FieldReader<u8, u8>;
///Field `DLYM4R` writer - Delay line for second microphone of pair 4
