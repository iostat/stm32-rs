...
///Field `ABMODE` reader - Alternate bytes mode
pub type ABMODE_R = crate::FieldReader<u8, u8>;
///Field `ABMODE` writer - Alternate bytes mode
...
///Field `DDRM` reader - Double data rate mode
pub type DDRM_R = crate::BitReader<bool>;
///Field `DDRM` writer - Double data rate mode
