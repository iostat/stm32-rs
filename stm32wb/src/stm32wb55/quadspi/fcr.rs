...
///Field `CTEF` reader - Clear transfer error flag
...
///Field `CTCF` reader - Clear transfer complete flag
...
///Field `CSMF` reader - Clear status match flag
...
///Field `CTOF` reader - Clear timeout flag
