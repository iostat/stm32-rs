...
///Field `COUNT4_RX` reader - Reception byte count
...
///`read()` method returns [count4_rx::R](R) reader structure
impl crate::Readable for COUNT4_RX_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [count4_rx::W](W) writer structure
impl crate::Writable for COUNT4_RX_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
///`reset()` method sets COUNT4_RX to value 0
